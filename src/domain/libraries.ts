...
const CANDIDATE_DEFINITIONS = [
  ...
  },
  {
    ...
    activity: '由 Radix、Floating UI 与 Material UI 的创建者维护，无障碍原语持续更新',
    bundleSize: '无样式运行时，按所用原语与子路径引入',
    typescript: '一等支持（源码级 TS）',
    styling: 'Unstyled；本站仅保留功能所需的结构 CSS',
    tagline: 'Headless React 原语库；本站展示不代表官方默认主题。',
  },
  {
    id: 'element-plus',
    framework: 'vue',
